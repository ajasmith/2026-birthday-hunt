...
\newcommand{\encodedpairbox}[1]{%
  \begin{tikzpicture}[baseline=(top.base)]
    \node[draw, line width=0.8pt, minimum width=1.35em, minimum height=1.55em, inner sep=0.08em] (top) {\strut #1};
    \node[draw, line width=0.8pt, minimum width=1.35em, minimum height=1.55em, inner sep=0.08em, anchor=north] at (top.south) {};
  \end{tikzpicture}%
}
